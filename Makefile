...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/clocksi/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/clocksi/lib;)
...
COMBO_PLT = $(HOME)/.clocksi_combo_dialyzer_plt
